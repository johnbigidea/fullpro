...
import com.app.rowmapper.QuestionRowMapper;
...
public class QuestionDaoImpl implements QuestionDao {
	...
	private static final Logger logger = LogManager.getLogger(QuestionDaoImpl.class);
		...
		public void addEmployee(Employee employee) {
				...
				if(employee!=null) {
					String addEmployee_sql = "INSERT INTO question (name,define, times,addtime,"
	...
	public List<Employee> findEmployeeByName(String name)  {
		...
		public boolean existsById(Integer id) {
		    return jdbcTemplate.queryForObject(
		        "SELECT EXISTS(SELECT 1 FROM question where id=?)", Boolean.class, id);
		}


		public void updateEmployee(Employee employee){
			String sql="update question set name=:name,"

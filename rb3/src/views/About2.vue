...
<script>
import { ElButton,ElRow,ElTabs,ElTabPane,ElCol,ElMenu,ElMenuItem,ElMenuItemGroup,ElSubMenu,ElRadioGroup,ElRadioButton,ElInput,ElIcon,ElTable,ElTableColumn,ElPopover} from 'element-plus'
...
{ 
  ...
  break; 
      ...
      name: 'App',
          components:{
            ElButton,
            ElRow,ElTabs,ElTabPane,ElCol,ElMenu,ElMenuItem,ElMenuItemGroup,ElSubMenu,ElRadioGroup,ElRadioButton,ElInput,ElIcon,ElTable,ElTableColumn,ElPopover
        }
})
</script>
